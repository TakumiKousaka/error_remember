...
from flaskdb.models import User, Item, Order, Hoge
from flaskdb.forms import LoginForm, AddItemForm, SearchItemForm, CheckOutForm, HogeForm
...
def hoge():
    ...
    if form.validate_on_submit():
        ...
        flash("hogehoge.", "info")
        return redirect(url_for("app.hoge"))

    return render_template("hoge.html", form=form)
